...
import com.vestel.launcher.ButtonDropTarget;
import com.vestel.launcher.DeleteDropTarget;
import com.vestel.launcher.InfoDropTarget;
import com.vestel.launcher.ItemInfo;
import com.vestel.launcher.LauncherSettings;
import com.vestel.launcher.UninstallDropTarget;
...
public class LoggerUtils {
    ...
    public static String getActionStr(LauncherLogProto.Action action) {
        switch(action.touch) {
            case LauncherLogProto.Action.TAP: return "TAP";
            case LauncherLogProto.Action.LONGPRESS: return "LONGPRESS";
            case LauncherLogProto.Action.DRAGDROP: return "DRAGDROP";
            case LauncherLogProto.Action.PINCH: return "PINCH";
            case LauncherLogProto.Action.SWIPE: return "SWIPE";
            case LauncherLogProto.Action.FLING: return "FLING";
    ...
    private static String getControlStr(LauncherLogProto.Target t) {
        if (t == null){
            return "";
        }
    ...
    private static LauncherLogProto.Target initTarget(View v, ItemInfo info) {
        LauncherLogProto.Target t = new LauncherLogProto.Target();
        t.type = LauncherLogProto.Target.ITEM;
    ...
    private static LauncherLogProto.Target initDropTarget(View v) {
        LauncherLogProto.Target t = new LauncherLogProto.Target();
        t.type = (v instanceof ButtonDropTarget)? LauncherLogProto.Target.CONTROL : LauncherLogProto.Target.CONTAINER;
        if (t.type == LauncherLogProto.Target.CONTAINER) {
            return t;
        }
    ...
    private static LauncherLogProto.Target initTarget(View v) {
        LauncherLogProto.Target t = new LauncherLogProto.Target();
        t.type = LauncherLogProto.Target.ITEM;
