...
import com.vestel.launcher.accessibility.LauncherAccessibilityDelegate;
import com.vestel.launcher.allapps.AllAppsContainerView;
import com.vestel.launcher.allapps.PredictiveAppsProvider;
import com.vestel.launcher.allapps.AllAppsTransitionController;
import com.vestel.launcher.allapps.DefaultAppSearchController;
import com.vestel.launcher.compat.AppWidgetManagerCompat;
import com.vestel.launcher.compat.LauncherActivityInfoCompat;
import com.vestel.launcher.compat.LauncherAppsCompat;
import com.vestel.launcher.compat.UserHandleCompat;
import com.vestel.launcher.compat.UserManagerCompat;
import com.vestel.launcher.config.FeatureFlags;
import com.vestel.launcher.config.ProviderConfig;
import com.vestel.launcher.dragndrop.DragController;
import com.vestel.launcher.dragndrop.DragLayer;
import com.vestel.launcher.dragndrop.DragOptions;
import com.vestel.launcher.dragndrop.DragView;
import com.vestel.launcher.dynamicui.ExtractedColors;
import com.vestel.launcher.folder.Folder;
import com.vestel.launcher.folder.FolderIcon;
import com.vestel.launcher.keyboard.ViewGroupFocusHelper;
import com.vestel.launcher.logging.FileLog;
import com.vestel.launcher.logging.UserEventDispatcher;
import com.vestel.launcher.model.WidgetsModel;
import com.vestel.launcher.pageindicators.PageIndicator;
import com.vestel.launcher.shortcuts.DeepShortcutManager;
import com.vestel.launcher.shortcuts.DeepShortcutsContainer;
import com.vestel.launcher.shortcuts.ShortcutKey;
import com.vestel.launcher.userevent.nano.LauncherLogProto;
import com.vestel.launcher.util.ActivityResultInfo;
import com.vestel.launcher.util.ComponentKey;
import com.vestel.launcher.util.ItemInfoMatcher;
import com.vestel.launcher.util.MultiHashMap;
import com.vestel.launcher.util.PackageManagerHelper;
import com.vestel.launcher.util.PendingRequestArgs;
import com.vestel.launcher.util.TestingUtils;
import com.vestel.launcher.util.Thunk;
import com.vestel.launcher.util.ViewOnDrawExecutor;
import com.vestel.launcher.widget.PendingAddWidgetInfo;
import com.vestel.launcher.widget.WidgetHostViewLoader;
import com.vestel.launcher.widget.WidgetsContainerView;
